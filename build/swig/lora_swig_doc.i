...
%feature("docstring") gr::lora::copy_cc "<+description of block+>

Constructor Specific Documentation:

Return a shared_ptr to a new instance of lora::copy_cc.

To avoid accidental use of raw pointers, lora::copy_cc's constructor is in a private implementation class. lora::copy_cc::make is the public interface for creating new instances.

Args:
    len_tag_key : "

%feature("docstring") gr::lora::copy_cc::make "<+description of block+>
