...
class demod(object):
    ...
    def make(spreading_factor: 'uint8_t', header: 'bool', payload_len: 'uint8_t', cr: 'uint8_t', crc: 'bool', low_data_rate: 'bool', beta: 'float', fft_factor: 'uint16_t', peak_search_algorithm: 'uint8_t', peak_search_phase_k: 'uint16_t', fs_bw_ratio: 'float') -> "gr::lora::demod::sptr":
        """
        make(uint8_t spreading_factor, bool header, uint8_t payload_len, uint8_t cr, bool crc, bool low_data_rate, float beta, uint16_t fft_factor, uint8_t peak_search_algorithm, uint16_t peak_search_phase_k, float fs_bw_ratio) -> demod_sptr
        ...
        Args:
            ...
            fs_bw_ratio : 
        """
        return _lora_swig.demod_make(spreading_factor, header, payload_len, cr, crc, low_data_rate, beta, fft_factor, peak_search_algorithm, peak_search_phase_k, fs_bw_ratio)
...
def demod_make(spreading_factor: 'uint8_t', header: 'bool', payload_len: 'uint8_t', cr: 'uint8_t', crc: 'bool', low_data_rate: 'bool', beta: 'float', fft_factor: 'uint16_t', peak_search_algorithm: 'uint8_t', peak_search_phase_k: 'uint16_t', fs_bw_ratio: 'float') -> "gr::lora::demod::sptr":
    """
...
class demod_sptr(object):
    ...
    def make(self, spreading_factor: 'uint8_t', header: 'bool', payload_len: 'uint8_t', cr: 'uint8_t', crc: 'bool', low_data_rate: 'bool', beta: 'float', fft_factor: 'uint16_t', peak_search_algorithm: 'uint8_t', peak_search_phase_k: 'uint16_t', fs_bw_ratio: 'float') -> "gr::lora::demod::sptr":
        """
        make(demod_sptr self, uint8_t spreading_factor, bool header, uint8_t payload_len, uint8_t cr, bool crc, bool low_data_rate, float beta, uint16_t fft_factor, uint8_t peak_search_algorithm, uint16_t peak_search_phase_k, float fs_bw_ratio) -> demod_sptr
        ...
        Args:
            ...
            fs_bw_ratio : 
        """
        return _lora_swig.demod_sptr_make(self, spreading_factor, header, payload_len, cr, crc, low_data_rate, beta, fft_factor, peak_search_algorithm, peak_search_phase_k, fs_bw_ratio)
...
class pyramid_demod(object):
    ...
    def make(spreading_factor: 'unsigned short', low_data_rate: 'bool', beta: 'float', fft_factor: 'unsigned short', threshold: 'float', fs_bw_ratio: 'float') -> "gr::lora::pyramid_demod::sptr":
        """
        make(unsigned short spreading_factor, bool low_data_rate, float beta, unsigned short fft_factor, float threshold, float fs_bw_ratio) -> pyramid_demod_sptr
        ...
        Args:
            ...
            fs_bw_ratio : 
        """
        return _lora_swig.pyramid_demod_make(spreading_factor, low_data_rate, beta, fft_factor, threshold, fs_bw_ratio)
...
def pyramid_demod_make(spreading_factor: 'unsigned short', low_data_rate: 'bool', beta: 'float', fft_factor: 'unsigned short', threshold: 'float', fs_bw_ratio: 'float') -> "gr::lora::pyramid_demod::sptr":
    """
...
class pyramid_demod_sptr(object):
    ...
    def make(self, spreading_factor: 'unsigned short', low_data_rate: 'bool', beta: 'float', fft_factor: 'unsigned short', threshold: 'float', fs_bw_ratio: 'float') -> "gr::lora::pyramid_demod::sptr":
        """
        make(pyramid_demod_sptr self, unsigned short spreading_factor, bool low_data_rate, float beta, unsigned short fft_factor, float threshold, float fs_bw_ratio) -> pyramid_demod_sptr
        ...
        Args:
            ...
            fs_bw_ratio : 
        """
        return _lora_swig.pyramid_demod_sptr_make(self, spreading_factor, low_data_rate, beta, fft_factor, threshold, fs_bw_ratio)
...
class copy_cc(object):
    ...
    def make(*args, **kwargs) -> "gr::lora::copy_cc::sptr":
        """
        make(std::string const & len_tag_key) -> copy_cc_sptr
        ...
        Args:
            len_tag_key : 
        """
        return _lora_swig.copy_cc_make(*args, **kwargs)

    make = staticmethod(make)
    __swig_destroy__ = _lora_swig.delete_copy_cc
    __del__ = lambda self: None
copy_cc_swigregister = _lora_swig.copy_cc_swigregister
copy_cc_swigregister(copy_cc)

def copy_cc_make(*args, **kwargs) -> "gr::lora::copy_cc::sptr":
    """
...
class copy_cc_sptr(object):
    """Proxy of C++ boost::shared_ptr<(gr::lora::copy_cc)> class."""
    ...
    def __init__(self, *args):
        """
        __init__(boost::shared_ptr<(gr::lora::copy_cc)> self) -> copy_cc_sptr
        __init__(boost::shared_ptr<(gr::lora::copy_cc)> self, copy_cc p) -> copy_cc_sptr
        """
        this = _lora_swig.new_copy_cc_sptr(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this

    def __deref__(self) -> "gr::lora::copy_cc *":
        """__deref__(copy_cc_sptr self) -> copy_cc"""
        return _lora_swig.copy_cc_sptr___deref__(self)

    __swig_destroy__ = _lora_swig.delete_copy_cc_sptr
    __del__ = lambda self: None

    def make(self, *args, **kwargs) -> "gr::lora::copy_cc::sptr":
        """
        make(copy_cc_sptr self, std::string const & len_tag_key) -> copy_cc_sptr
        ...
        Args:
            len_tag_key : 
        """
        return _lora_swig.copy_cc_sptr_make(self, *args, **kwargs)


    def history(self) -> "unsigned int":
        """history(copy_cc_sptr self) -> unsigned int"""
        return _lora_swig.copy_cc_sptr_history(self)


    def declare_sample_delay(self, *args) -> "void":
        """
        declare_sample_delay(copy_cc_sptr self, int which, int delay)
        declare_sample_delay(copy_cc_sptr self, unsigned int delay)
        """
        return _lora_swig.copy_cc_sptr_declare_sample_delay(self, *args)


    def sample_delay(self, which: 'int') -> "unsigned int":
        """sample_delay(copy_cc_sptr self, int which) -> unsigned int"""
        return _lora_swig.copy_cc_sptr_sample_delay(self, which)


    def set_output_multiple(self, multiple: 'int') -> "void":
        """set_output_multiple(copy_cc_sptr self, int multiple)"""
        return _lora_swig.copy_cc_sptr_set_output_multiple(self, multiple)


    def output_multiple(self) -> "int":
        """output_multiple(copy_cc_sptr self) -> int"""
        return _lora_swig.copy_cc_sptr_output_multiple(self)


    def relative_rate(self) -> "double":
        """relative_rate(copy_cc_sptr self) -> double"""
        return _lora_swig.copy_cc_sptr_relative_rate(self)


    def relative_rate_i(self) -> "uint64_t":
        """relative_rate_i(copy_cc_sptr self) -> uint64_t"""
        return _lora_swig.copy_cc_sptr_relative_rate_i(self)


    def relative_rate_d(self) -> "uint64_t":
        """relative_rate_d(copy_cc_sptr self) -> uint64_t"""
        return _lora_swig.copy_cc_sptr_relative_rate_d(self)


    def start(self) -> "bool":
        """start(copy_cc_sptr self) -> bool"""
        return _lora_swig.copy_cc_sptr_start(self)


    def stop(self) -> "bool":
        """stop(copy_cc_sptr self) -> bool"""
        return _lora_swig.copy_cc_sptr_stop(self)


    def nitems_read(self, which_input: 'unsigned int') -> "uint64_t":
        """nitems_read(copy_cc_sptr self, unsigned int which_input) -> uint64_t"""
        return _lora_swig.copy_cc_sptr_nitems_read(self, which_input)


    def nitems_written(self, which_output: 'unsigned int') -> "uint64_t":
        """nitems_written(copy_cc_sptr self, unsigned int which_output) -> uint64_t"""
        return _lora_swig.copy_cc_sptr_nitems_written(self, which_output)


    def set_log_level(self, level: 'std::string') -> "void":
        """set_log_level(copy_cc_sptr self, std::string level)"""
        return _lora_swig.copy_cc_sptr_set_log_level(self, level)


    def log_level(self) -> "std::string":
        """log_level(copy_cc_sptr self) -> std::string"""
        return _lora_swig.copy_cc_sptr_log_level(self)


    def max_noutput_items(self) -> "int":
        """max_noutput_items(copy_cc_sptr self) -> int"""
        return _lora_swig.copy_cc_sptr_max_noutput_items(self)


    def set_max_noutput_items(self, m: 'int') -> "void":
        """set_max_noutput_items(copy_cc_sptr self, int m)"""
        return _lora_swig.copy_cc_sptr_set_max_noutput_items(self, m)


    def unset_max_noutput_items(self) -> "void":
        """unset_max_noutput_items(copy_cc_sptr self)"""
        return _lora_swig.copy_cc_sptr_unset_max_noutput_items(self)


    def is_set_max_noutput_items(self) -> "bool":
        """is_set_max_noutput_items(copy_cc_sptr self) -> bool"""
        return _lora_swig.copy_cc_sptr_is_set_max_noutput_items(self)


    def set_min_noutput_items(self, m: 'int') -> "void":
        """set_min_noutput_items(copy_cc_sptr self, int m)"""
        return _lora_swig.copy_cc_sptr_set_min_noutput_items(self, m)


    def min_noutput_items(self) -> "int":
        """min_noutput_items(copy_cc_sptr self) -> int"""
        return _lora_swig.copy_cc_sptr_min_noutput_items(self)


    def max_output_buffer(self, i: 'int') -> "long":
        """max_output_buffer(copy_cc_sptr self, int i) -> long"""
        return _lora_swig.copy_cc_sptr_max_output_buffer(self, i)


    def set_max_output_buffer(self, *args) -> "void":
        """
        set_max_output_buffer(copy_cc_sptr self, long max_output_buffer)
        set_max_output_buffer(copy_cc_sptr self, int port, long max_output_buffer)
        """
        return _lora_swig.copy_cc_sptr_set_max_output_buffer(self, *args)


    def min_output_buffer(self, i: 'int') -> "long":
        """min_output_buffer(copy_cc_sptr self, int i) -> long"""
        return _lora_swig.copy_cc_sptr_min_output_buffer(self, i)


    def set_min_output_buffer(self, *args) -> "void":
        """
        set_min_output_buffer(copy_cc_sptr self, long min_output_buffer)
        set_min_output_buffer(copy_cc_sptr self, int port, long min_output_buffer)
        """
        return _lora_swig.copy_cc_sptr_set_min_output_buffer(self, *args)


    def pc_noutput_items(self) -> "float":
        """pc_noutput_items(copy_cc_sptr self) -> float"""
        return _lora_swig.copy_cc_sptr_pc_noutput_items(self)


    def pc_noutput_items_avg(self) -> "float":
        """pc_noutput_items_avg(copy_cc_sptr self) -> float"""
        return _lora_swig.copy_cc_sptr_pc_noutput_items_avg(self)


    def pc_noutput_items_var(self) -> "float":
        """pc_noutput_items_var(copy_cc_sptr self) -> float"""
        return _lora_swig.copy_cc_sptr_pc_noutput_items_var(self)


    def pc_nproduced(self) -> "float":
        """pc_nproduced(copy_cc_sptr self) -> float"""
        return _lora_swig.copy_cc_sptr_pc_nproduced(self)


    def pc_nproduced_avg(self) -> "float":
        """pc_nproduced_avg(copy_cc_sptr self) -> float"""
        return _lora_swig.copy_cc_sptr_pc_nproduced_avg(self)


    def pc_nproduced_var(self) -> "float":
        """pc_nproduced_var(copy_cc_sptr self) -> float"""
        return _lora_swig.copy_cc_sptr_pc_nproduced_var(self)


    def pc_input_buffers_full(self, *args) -> "std::vector< float,std::allocator< float > >":
        """
        pc_input_buffers_full(copy_cc_sptr self, int which) -> float
        pc_input_buffers_full(copy_cc_sptr self) -> pmt_vector_float
        """
        return _lora_swig.copy_cc_sptr_pc_input_buffers_full(self, *args)


    def pc_input_buffers_full_avg(self, *args) -> "std::vector< float,std::allocator< float > >":
        """
        pc_input_buffers_full_avg(copy_cc_sptr self, int which) -> float
        pc_input_buffers_full_avg(copy_cc_sptr self) -> pmt_vector_float
        """
        return _lora_swig.copy_cc_sptr_pc_input_buffers_full_avg(self, *args)


    def pc_input_buffers_full_var(self, *args) -> "std::vector< float,std::allocator< float > >":
        """
        pc_input_buffers_full_var(copy_cc_sptr self, int which) -> float
        pc_input_buffers_full_var(copy_cc_sptr self) -> pmt_vector_float
        """
        return _lora_swig.copy_cc_sptr_pc_input_buffers_full_var(self, *args)


    def pc_output_buffers_full(self, *args) -> "std::vector< float,std::allocator< float > >":
        """
        pc_output_buffers_full(copy_cc_sptr self, int which) -> float
        pc_output_buffers_full(copy_cc_sptr self) -> pmt_vector_float
        """
        return _lora_swig.copy_cc_sptr_pc_output_buffers_full(self, *args)


    def pc_output_buffers_full_avg(self, *args) -> "std::vector< float,std::allocator< float > >":
        """
        pc_output_buffers_full_avg(copy_cc_sptr self, int which) -> float
        pc_output_buffers_full_avg(copy_cc_sptr self) -> pmt_vector_float
        """
        return _lora_swig.copy_cc_sptr_pc_output_buffers_full_avg(self, *args)


    def pc_output_buffers_full_var(self, *args) -> "std::vector< float,std::allocator< float > >":
        """
        pc_output_buffers_full_var(copy_cc_sptr self, int which) -> float
        pc_output_buffers_full_var(copy_cc_sptr self) -> pmt_vector_float
        """
        return _lora_swig.copy_cc_sptr_pc_output_buffers_full_var(self, *args)


    def pc_work_time(self) -> "float":
        """pc_work_time(copy_cc_sptr self) -> float"""
        return _lora_swig.copy_cc_sptr_pc_work_time(self)


    def pc_work_time_avg(self) -> "float":
        """pc_work_time_avg(copy_cc_sptr self) -> float"""
        return _lora_swig.copy_cc_sptr_pc_work_time_avg(self)


    def pc_work_time_var(self) -> "float":
        """pc_work_time_var(copy_cc_sptr self) -> float"""
        return _lora_swig.copy_cc_sptr_pc_work_time_var(self)


    def pc_work_time_total(self) -> "float":
        """pc_work_time_total(copy_cc_sptr self) -> float"""
        return _lora_swig.copy_cc_sptr_pc_work_time_total(self)


    def pc_throughput_avg(self) -> "float":
        """pc_throughput_avg(copy_cc_sptr self) -> float"""
        return _lora_swig.copy_cc_sptr_pc_throughput_avg(self)


    def set_processor_affinity(self, mask: 'std::vector< int,std::allocator< int > > const &') -> "void":
        """set_processor_affinity(copy_cc_sptr self, std::vector< int,std::allocator< int > > const & mask)"""
        return _lora_swig.copy_cc_sptr_set_processor_affinity(self, mask)


    def unset_processor_affinity(self) -> "void":
        """unset_processor_affinity(copy_cc_sptr self)"""
        return _lora_swig.copy_cc_sptr_unset_processor_affinity(self)


    def processor_affinity(self) -> "std::vector< int,std::allocator< int > >":
        """processor_affinity(copy_cc_sptr self) -> std::vector< int,std::allocator< int > >"""
        return _lora_swig.copy_cc_sptr_processor_affinity(self)


    def active_thread_priority(self) -> "int":
        """active_thread_priority(copy_cc_sptr self) -> int"""
        return _lora_swig.copy_cc_sptr_active_thread_priority(self)


    def thread_priority(self) -> "int":
        """thread_priority(copy_cc_sptr self) -> int"""
        return _lora_swig.copy_cc_sptr_thread_priority(self)


    def set_thread_priority(self, priority: 'int') -> "int":
        """set_thread_priority(copy_cc_sptr self, int priority) -> int"""
        return _lora_swig.copy_cc_sptr_set_thread_priority(self, priority)


    def name(self) -> "std::string":
        """name(copy_cc_sptr self) -> std::string"""
        return _lora_swig.copy_cc_sptr_name(self)


    def symbol_name(self) -> "std::string":
        """symbol_name(copy_cc_sptr self) -> std::string"""
        return _lora_swig.copy_cc_sptr_symbol_name(self)


    def input_signature(self) -> "gr::io_signature::sptr":
        """input_signature(copy_cc_sptr self) -> io_signature_sptr"""
        return _lora_swig.copy_cc_sptr_input_signature(self)


    def output_signature(self) -> "gr::io_signature::sptr":
        """output_signature(copy_cc_sptr self) -> io_signature_sptr"""
        return _lora_swig.copy_cc_sptr_output_signature(self)


    def unique_id(self) -> "long":
        """unique_id(copy_cc_sptr self) -> long"""
        return _lora_swig.copy_cc_sptr_unique_id(self)


    def to_basic_block(self) -> "gr::basic_block_sptr":
        """to_basic_block(copy_cc_sptr self) -> basic_block_sptr"""
        return _lora_swig.copy_cc_sptr_to_basic_block(self)


    def check_topology(self, ninputs: 'int', noutputs: 'int') -> "bool":
        """check_topology(copy_cc_sptr self, int ninputs, int noutputs) -> bool"""
        return _lora_swig.copy_cc_sptr_check_topology(self, ninputs, noutputs)


    def alias(self) -> "std::string":
        """alias(copy_cc_sptr self) -> std::string"""
        return _lora_swig.copy_cc_sptr_alias(self)


    def set_block_alias(self, name: 'std::string') -> "void":
        """set_block_alias(copy_cc_sptr self, std::string name)"""
        return _lora_swig.copy_cc_sptr_set_block_alias(self, name)


    def _post(self, which_port: 'swig_pmt_ptr', msg: 'swig_pmt_ptr') -> "void":
        """_post(copy_cc_sptr self, swig_pmt_ptr which_port, swig_pmt_ptr msg)"""
        return _lora_swig.copy_cc_sptr__post(self, which_port, msg)


    def message_ports_in(self) -> "pmt::pmt_t":
        """message_ports_in(copy_cc_sptr self) -> swig_pmt_ptr"""
        return _lora_swig.copy_cc_sptr_message_ports_in(self)


    def message_ports_out(self) -> "pmt::pmt_t":
        """message_ports_out(copy_cc_sptr self) -> swig_pmt_ptr"""
        return _lora_swig.copy_cc_sptr_message_ports_out(self)


    def message_subscribers(self, which_port: 'swig_pmt_ptr') -> "pmt::pmt_t":
        """message_subscribers(copy_cc_sptr self, swig_pmt_ptr which_port) -> swig_pmt_ptr"""
        return _lora_swig.copy_cc_sptr_message_subscribers(self, which_port)

copy_cc_sptr_swigregister = _lora_swig.copy_cc_sptr_swigregister
copy_cc_sptr_swigregister(copy_cc_sptr)


copy_cc_sptr.__repr__ = lambda self: "<gr_block %s (%d)>" % (self.name(), self.unique_id())
copy_cc = copy_cc.make;
